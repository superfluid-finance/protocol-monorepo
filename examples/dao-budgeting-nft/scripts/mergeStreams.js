...
async function main() {
  ...
  //make sure to change the params to the correct flowIds you'd like to merge
  const txData = (await budgetNFT.methods.mergeStreams(0, 1)).encodeABI() //the _receiver (caller) must own both NFTs
