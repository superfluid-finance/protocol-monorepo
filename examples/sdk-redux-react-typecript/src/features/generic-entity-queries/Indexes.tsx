...
import { Index_OrderBy } from "@superfluid-finance/sdk-core/dist/module/subgraph/schema.generated";

export const Indexes: FC = (): ReactElement => {
    ...
    const order = !!sortModel[0]
        ? {
              orderBy: sortModel[0].field as Index_OrderBy,
              orderDirection: sortModel[0].sort!,
          }
        : undefined;

    const queryResult = sfSubgraph.useIndexesQuery({
