...
import { Stream_OrderBy } from "@superfluid-finance/sdk-core/dist/module/subgraph/schema.generated";
...
export const Streams: FC = (): ReactElement => {
    ...
    const order = !!sortModel[0]
        ? {
              orderBy: sortModel[0].field as Stream_OrderBy,
              orderDirection: sortModel[0].sort!,
          }
        : undefined;

    const queryResult = sfApi.useStreamsQuery({
