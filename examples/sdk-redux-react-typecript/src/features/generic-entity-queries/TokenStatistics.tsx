...
import { TokenStatistic_OrderBy } from "@superfluid-finance/sdk-core/dist/main/subgraph/schema.generated";
...
export const TokenStatistics: FC = (): ReactElement => {
    ...
    const order = !!sortModel[0]
        ? {
              orderBy: sortModel[0].field as TokenStatistic_OrderBy,
              orderDirection: sortModel[0].sort!,
          }
        : undefined;

    const queryResult = sfApi.useTokenStatisticsQuery({
