...
contract FoundrySuperfluidTester is Test {
    ...
    function _definition_Global_Invariants() internal view returns (bool) {
        return
            _definition_Liquidity_Sum_Invariant() &&
            _definition_Net_Flow_Rate_Sum_Invariant();
    }
    ...
    function _definition_Liquidity_Sum_Invariant() internal view returns (bool) {
        int256 liquiditySum;
    ...
    function _definition_Net_Flow_Rate_Sum_Invariant()
        internal
        view
        returns (bool)
    {
    ...
    function _assert_Global_Invariants() internal {
        assertTrue(_definition_Global_Invariants());
    }

    function _assert_Liquidity_Sum_Invariant() internal {
        assertTrue(_definition_Liquidity_Sum_Invariant());
    }

    function _assert_Net_Flow_Rate_Sum_Invariant() internal {
        assertTrue(_definition_Net_Flow_Rate_Sum_Invariant());
    }

    /*//////////////////////////////////////////////////////////////////////////
                                    Assertion Helpers
    //////////////////////////////////////////////////////////////////////////*/
    function _assert_Modify_Flow_And_Net_Flow_Is_Expected(
        address flowSender,
    ...
    function _assert_Modify_Flow_And_Flow_Info_Is_Expected(
        address flowSender,
        address flowReceiver,
    ...
    function _assert_Flow_Info_Is_Empty(
        address flowSender,
        address flowReceiver
    ) internal {
        _assert_Modify_Flow_And_Flow_Info_Is_Expected(
            flowSender,
            flowReceiver,
            0,
            0,
    ...
    function _assume_Valid_Flow_Rate(
        uint32 a
    ...
    function _helper_Create_Flow_And_Assert_Global_Invariants(
        address flowSender,
        address flowReceiver,
        uint32 _flowRate
    ) internal returns (int96 absoluteFlowRate) {
        int96 flowRate = _assume_Valid_Flow_Rate(_flowRate);
        ...
        _assert_Modify_Flow_And_Net_Flow_Is_Expected(
            flowSender,
            flowReceiver,
            flowRate,
