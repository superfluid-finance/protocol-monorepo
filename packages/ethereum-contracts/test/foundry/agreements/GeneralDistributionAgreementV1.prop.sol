...
contract GeneralDistributionAgreementV1Properties is GeneralDistributionAgreementV1, Test {
    constructor(address delegatableTokenMonad_)
        GeneralDistributionAgreementV1(ISuperfluid(address(0)), delegatableTokenMonad_)
    { }
    ...
    //     (, GeneralDistributionAgreementV1.PoolMemberData memory decoded) = _decodePoolMemberData(uint256(encoded[0]));
