...
contract SuperAppBaseCFATest is FoundrySuperfluidTester {
    ...
    function _gen_Manifest(bool activateOnCreated, bool activateOnUpdated, bool activateOnDeleted) internal pure returns (uint256) {
    ...
    function _deploy_Super_App_And_Get_Config(bool activateOnCreated, bool activateOnUpdated, bool activateOnDeleted) internal returns (SuperAppBaseCFATester, uint256 configWord) {
        SuperAppBaseCFATester mySuperApp = new SuperAppBaseCFATester(sf.host, activateOnCreated, activateOnUpdated, activateOnDeleted);
        uint256 appConfig = _gen_Manifest(activateOnCreated, activateOnUpdated, activateOnDeleted);
    ...
    function testOnFlagsSetAppManifest(bool activateOnCreated, bool activateOnUpdated, bool activateOnDeleted) public {
        //all onOperations
        (SuperAppBaseCFATester mySuperApp, uint256 configWord) = _deploy_Super_App_And_Get_Config(activateOnCreated, activateOnUpdated, activateOnDeleted);
