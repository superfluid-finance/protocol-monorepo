...
contract FlowNFTBasePropertyTest is FoundrySuperfluidTester {
    ...
    function testNoTokenIdCollisionDifferentTokenSameSenderReceiver(address tokenA, address tokenB) public view {
    ...
    function testBalanceOfIsAlwaysEqualToOne(address account) public view {
