function hotfuzzPatchTruffleConfig(c) {
    if (process.env.HOT_FUZZ_MODE) {
        ...
        c.compilers.solc.settings.libraries = {
            ...
            "@superfluid-finance/ethereum-contracts/contracts/utils/deployers/SuperfluidCFAv1DeployerLibrary.sol": {
                SuperfluidCFAv1DeployerLibrary: "0x" + "0".repeat(38) + "f2",
            },
            "@superfluid-finance/ethereum-contracts/contracts/utils/deployers/SuperfluidGovDeployerLibrary.sol": {
                SuperfluidGovDeployerLibrary: "0x" + "0".repeat(38) + "f3",
            },
            "@superfluid-finance/ethereum-contracts/contracts/utils/deployers/SuperfluidHostDeployerLibrary.sol": {
                SuperfluidHostDeployerLibrary: "0x" + "0".repeat(38) + "f4",
            },
            "@superfluid-finance/ethereum-contracts/contracts/utils/deployers/SuperfluidIDAv1DeployerLibrary.sol": {
                SuperfluidIDAv1DeployerLibrary: "0x" + "0".repeat(38) + "f5",
            },
            "@superfluid-finance/ethereum-contracts/contracts/utils/deployers/SuperfluidPeripheryDeployerLibrary.sol": {
                SuperfluidPeripheryDeployerLibrary: "0x" + "0".repeat(38) + "f6",
            },
            "@superfluid-finance/ethereum-contracts/contracts/utils/deployers/SuperfluidSuperTokenFactoryHelperDeployerLibrary.sol": {
                SuperfluidSuperTokenFactoryHelperDeployerLibrary: "0x" + "0".repeat(38) + "f7",
            },
        };
