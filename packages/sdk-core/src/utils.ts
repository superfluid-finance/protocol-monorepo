...
export const getPerSecondFlowRateByYear = (amountPerYear: string) => {
    return Math.round(
        (Number(amountPerYear) / YEAR_IN_SECONDS) * 10 ** 18
    ).toString();
};
...
export const getPerSecondFlowRateByMonth = (amountPerMonth: string) => {
    return Math.round(
        (Number(amountPerMonth) / MONTH_IN_SECONDS) * 10 ** 18
    ).toString();
};
...
export const getPerSecondFlowRateByWeek = (amountPerWeek: string) => {
    return Math.round(
        (Number(amountPerWeek) / WEEK_IN_SECONDS) * 10 ** 18
    ).toString();
};
...
export const getPerSecondFlowRateByDay = (amountPerDay: string) => {
    return Math.round(
        (Number(amountPerDay) / DAY_IN_SECONDS) * 10 ** 18
    ).toString();
};
...
export const getFlowAmountByPerSecondFlowRate = (perSecondFlowRate: string) => {
    const decimalFlowRate = Number(perSecondFlowRate) / 10 ** 18;
    return {
