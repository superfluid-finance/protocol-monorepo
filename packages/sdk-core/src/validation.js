...
const schema11 = {
    ...
    properties: { isListed: { type: "boolean", nullable: true } },
};
...
function validate10(
    ...
    /*# sourceURL="validateSuperTokenRequest" */ let vErrors = null;
    let errors = 0;
    if (errors === 0) {
...
function validate11(
    ...
    /*# sourceURL="validateEventRequest" */ let vErrors = null;
    let errors = 0;
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            const _errs1 = errors;
                    ...
                    if (data.timestamp_gt !== undefined) {
                        ...
                        if (
                            ...
                            validate11.errors = [
                                {
                                    instancePath:
                                        instancePath + "/timestamp_gt",
                                    schemaPath:
                                        "#/properties/timestamp_gt/type",
                                    keyword: "type",
                                    params: { type: "number" },
...
function validate12(
    ...
    /*# sourceURL="validateIndexRequest" */ let vErrors = null;
    let errors = 0;
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            const _errs1 = errors;
                            ...
                            if (typeof data0 === "string") {
                                if (!formats2.test(data0)) {
                                    validate12.errors = [
                                        {
                                            instancePath:
                                                instancePath + "/indexId",
                                            schemaPath:
                                                "#/properties/indexId/format",
                                            keyword: "format",
                                            params: { format: "stringInteger" },
                                            message:
                                                'must match format "' +
                                                "stringInteger" +
                                                '"',
...
function validate13(
    ...
    /*# sourceURL="validateAccountTokenSnapshotRequest" */ let vErrors = null;
    let errors = 0;
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            const _errs1 = errors;
...
const schema15 = {
    ...
    additionalProperties: false,
    properties: {
        subscriber: { type: "string", format: "stringInteger", nullable: true },
...
function validate14(
    ...
    /*# sourceURL="validateIndexSubscriptionRequest" */ let vErrors = null;
    let errors = 0;
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            const _errs1 = errors;
                            ...
                            if (typeof data0 === "string") {
                                if (!formats2.test(data0)) {
                                    validate14.errors = [
                                        {
                                            instancePath:
                                                instancePath + "/subscriber",
                                            schemaPath:
                                                "#/properties/subscriber/format",
                                            keyword: "format",
                                            params: { format: "stringInteger" },
                                            message:
                                                'must match format "' +
...
function validate15(
    ...
    /*# sourceURL="validateStreamRequest" */ let vErrors = null;
    let errors = 0;
    if (errors === 0) {
        if (data && typeof data == "object" && !Array.isArray(data)) {
            const _errs1 = errors;
