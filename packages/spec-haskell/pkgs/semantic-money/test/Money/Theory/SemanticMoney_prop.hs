...
uu_twice_shift2 x1 x2 = uu_f1_f2 (shift2 x1) (shift2 x2)
uu_twice_flow2 r1 r2 = uu_f1_f2 (flow2 r1) (flow2 r2)
...
one2one_tests = describe "1to1 2-primitives" $ do
        it "uidx:uidx twice shift2" $ property uu_twice_shift2
        it "uidx:uidx twice flow2"  $ property uu_twice_flow2
