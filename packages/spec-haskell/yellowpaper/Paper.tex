...
\begin{itemize}
\item If time is included the shared context, then monetary value of each money unit can be continuous over time.
\item A subset of money units can also have their value functions depending on the same information in shared
