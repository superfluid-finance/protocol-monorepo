...
In Chapter 2, we shall first explore the foundation for the survey. Here we present a formal definition of payment system,
...
We first define a payment system, whereby:
...
This discrete nature of money distribution is schematically depicted in {\ref{fig:discrete-md}}:
