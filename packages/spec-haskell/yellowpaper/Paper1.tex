...
To finish, here is the illustration of data structures for the denotational payment primitives
implemented with agreement framework:

\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{../assets/agreement-data-structures.png}
