...
namespace EnumerableSet {
    ...
    func add{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(set: Set, value: felt) -> (set: Set, success: felt){
    ...
    func contains{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(set: Set, value: felt) -> (success: felt){
        let found = find(set, value);
        return (success=found);
    }

    func find{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(set: Set, value: felt) -> (success: felt){
        if (set.length != 0){
