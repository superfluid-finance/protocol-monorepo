...
func __setup__{syscall_ptr: felt*}() {
    %{
        ...
        context.supertoken_contract_address = deploy_contract("./src/tokens/ERC20x/SuperToken/SuperTokenImpl.cairo", [1539470638642759296633, 21332, 18, 702498541217843554161684456503677314204169075528858798316766864181608813801]).contract_address
...
func test_flow1to2{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    ISuperToken.mint(contract_address=supertoken_contract_address, receiver=account1, amount=MINT_AMOUNT);
...
//     ISuperTokenPool.updateMember(contract_address=pool, memberAddress=test_account_address1, unit=u1);
//     let (member_data_1) = ISuperTokenPool.getMember(contract_address=pool, memberAddress=test_account_address1);
//     assert member_data_1.owned_unit = u1;
//     ISuperTokenPool.updateMember(contract_address=pool, memberAddress=test_account_address2, unit=u2);
//     let (member_data_2) = ISuperTokenPool.getMember(contract_address=pool, memberAddress=test_account_address2);
...
// ITestAccount.execute(contract_address=test_account_address1, calls_len=1, calls=calls, calldata_len=1, calldata=calldata);
...
//     ITestAccount.execute(contract_address=test_account_address2, calls_len=1, calls=calls, calldata_len=1, calldata=calldata);
...
//     syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr
// }(fr: felt, u1: felt, u2: felt, account1: felt, t1: felt) {
//     alloc_locals;
//     let tu = u1 + u2;
//     %{ assume(ids.tu > 0) %}
...
//         contract_address=pool, time=timestamp, memberAddress=test_account_address1
//     );
//     let (claimableForAccount3) = ISuperTokenPool.getClaimable(
//         contract_address=pool, time=timestamp, memberAddress=test_account_address2
//     );
...
//     );
//     let buffer = 42 * 60 * fr;
//     assert balanceOfAccount1 = MINT_AMOUNT - (buffer);
//     // let tu = u1 + u2;
