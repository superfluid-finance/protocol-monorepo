...
const MAX_SAFE_MILLISECOND = BigNumber.from("8640000000000") // This number is also defined as MAX_SAFE_MILLISECOND in packages/subgraph/src/utils.ts
/**************************************************************************
...
export function calculateMaybeCriticalAtTimestamp(
    ...
    if (calculatedCriticalTimestamp.gt(MAX_SAFE_MILLISECOND)) {
        return MAX_SAFE_MILLISECOND.toString();
    }
