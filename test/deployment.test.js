...
contract("deployment test", () => {
    ...
    it("Deploy/upgrade/reset Superfluid Framework", async () => {
        ...
        const sf1Contract = await ISuperfluid.at(superfluid1);
        assert.isTrue(await sf1Contract.isAgreementListed.call(cfa1));
        assert.isTrue(await sf1Contract.isAgreementListed.call(ida1));
